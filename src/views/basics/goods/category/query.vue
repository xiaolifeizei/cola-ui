  ...
  <div class="query-content">
    <el-form ref="queryForm" :model="form.data" :inline="true">
      <el-form-item prop="name">
        <el-input v-model="form.data.name" :clearable="true" placeholder="请输入物资分类名称" />
      </el-form-item>
      <el-form-item prop="code">
        <el-input v-model="form.data.code" :clearable="true" placeholder="请输入物资分类编码" />
      </el-form-item>
