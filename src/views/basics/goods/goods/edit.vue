<template>
  <div>
    ...
    <el-dialog :append-to-body="true" title="修改物资" :visible.sync="dialogShow" width="600px" @close="cancelEdit">
...
<script>
import { updateGoods } from '@/api/basics/goods/goods'
import { getCategoryByGoodsId } from '@/api/basics/goods/category'
...
export default {
  ...
  methods: {
    ...
    showEdit(row) {
      ...
      // 获取该物资的分类
      getCategoryByGoodsId(this.form.id).then(res => {
        if (res.data.list) {
          let categoryId = ''
