<template>
  <div>
    ...
    <el-dialog :append-to-body="true" title="添加客户分类" :visible.sync="dialogShow" width="600px" @close="cancelAdd">
...
<script>
import { addCategory } from '@/api/basics/customer/category'

export default {
  name: 'CustomerCategoryAdd',
  data() {
    return {
      table: {},
      dialogShow: false,
